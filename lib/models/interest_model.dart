...
// //   String? privacy;
// //
// //   InterestModel({this.id, this.interests, this.privacy});
// //
// //   InterestModel.fromJson(Map<String, dynamic> json) {
// //     id = json['id'];
...
//   Data? data;
//
//   InterestModel({this.error, this.message, this.data});
//
//   InterestModel.fromJson(Map<String, dynamic> json) {
//     error = json['error'];
//     message = json['message'];
...
//   String? privacy;
//
//   Data({this.id, this.interests, this.privacy});
//
//   Data.fromJson(Map<String, dynamic> json) {
//     id = json['id'];
//     interests = json['interests'].cast<String>();
...
class InterestModel {
  ...
  InterestModel({this.id, this.interests});
