...
class DontProductAddBottomSheetWidget extends StatefulWidget {
  final String productType;
  DontProductAddBottomSheetWidget({
    Key? key,
    required this.productType,
  }) : super(key: key);

  @override
  State<DontProductAddBottomSheetWidget> createState() =>
      _DontProductAddBottomSheetWidgetWidgetState();
}

class _DontProductAddBottomSheetWidgetWidgetState
    extends State<DontProductAddBottomSheetWidget> {
