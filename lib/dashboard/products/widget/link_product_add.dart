...
class LinkAlreadyProductAdd extends StatefulWidget {
  final String productLink;
  final ProductTypeModel? model;

  // final LoginResponse response;
  const LinkAlreadyProductAdd({
    Key? key,
    this.model,
    required this.productLink,
  }) : super(key: key);
  ...
  @override
  State<LinkAlreadyProductAdd> createState() => _LinkAlreadyProductAddState();
}

class _LinkAlreadyProductAddState extends State<LinkAlreadyProductAdd> {
  final titleController = TextEditingController();
  final productLinkController = TextEditingController();
  final priceController = TextEditingController();
  final dateController = TextEditingController();
