...
import '../../new_screens/share_product_details.dart';
                                                  ...
                                                  Expanded(
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        Text(DateTime.now()
                                                                    .difference(DateTime.parse(activity1!
                                                                        .data![
                                                                            i]
                                                                        .createdAt
                                                                        .toString()))
                                                                    .inMinutes <=
                                                                59
                                                            ? "${DateTime.now().difference(DateTime.parse(activity1!.data![i].createdAt.toString())).inMinutes} min ago"
                                                            : DateTime.now()
                                                                        .difference(DateTime.parse(activity1!
                                                                            .data![i]
                                                                            .createdAt
                                                                        ...
                                                                        .inHours <=
                                                                    23
                                                                ? "${DateTime.now().difference(DateTime.parse(activity1!.data![i].createdAt.toString())).inHours} hr ago"
                                                                : "${DateTime.now().difference(DateTime.parse(activity1!.data![i].createdAt.toString())).inDays} days ago"),
                                                      ],
                                                    ),
                                                  ),
                                                  SizedBox(
