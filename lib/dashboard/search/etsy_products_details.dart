...
class EtsyProductDetails extends StatefulWidget {
  ...
  const EtsyProductDetails({Key? key,
    ...
    required this.productDescription, required this.productId, required this.productUrl,
  }) : super(key: key);
                                            ...
                                            child: LightYellowButtonWithText(
                                                ...
                                                onTap: () {
                                                  ...
                                                  etsyStoreApi(
                                                    ...
                                                    link: widget.productUrl,
                                                    price: widget.productPrice,
                                                    purchaseDate: dateFormat,
                                                    status: 'public',
                                                    photoUrl: imageModel!.results![0].urlFullxfull.toString(),
                                                    photo: '',
                                                  ).then((value) {
                                                    if(value['status'] == true) {
