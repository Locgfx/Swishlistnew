...
class FriendProfile extends StatefulWidget {
  ...
  /*  required this.friendName,
    required this.friendUserName*/}) : super(key: key);
              ...
              ProfileRow(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => FProfile(friendId: widget.friendId,),
                    ),
                  );
                },
              ),
              ...
              ProfileRow(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => FSizesAndWeights(friendId: widget.friendId,),
                    ),
                  );
                },
              ),
              ...
              ProfileRow(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => FFavourites(friendId: widget.friendId,),
                    ),
                  );
                },
              ),
              ...
              ProfileRow(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => FPets(friendId: widget.friendId,),
                    ),
                  );
                },
              ),
              ...
              ProfileRow(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => FDatesAndEvents(friendId: widget.friendId,),
                    ),
                  );
                },
              ),
              ...
              ProfileRow(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => FFamily(friendId: widget.friendId,),
                    ),
                  );
                },
              ),
