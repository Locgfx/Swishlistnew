...
class FriendWantProducts extends StatefulWidget {
  ...
  // final bool isUser;
  const
  FriendWantProducts({Key? key,
    required this.friendId, required this.friendName,/* required this.isUser*/}) : super(key: key);

  @override
  State<FriendWantProducts> createState() => _FriendWantProductsState();
}

class _FriendWantProductsState extends State<FriendWantProducts> {
                                    ...
                                    onTap: () {
                                        Navigator.push(
                                            ...
                                            MaterialPageRoute(
                                                builder: (context) =>
                                                    ProductDetail(
                                                      name: products!.data!.want![i].name.toString(),
                                                      price:products!.data!.want![i].price.toString(),
                                                      link: products!.data!.want![i].link.toString(),
                                                      image: baseUrl+products!.data!.want![i].photo.toString(),
                                                      purchaseDate: products!.data!.want![i].purchasedDate.toString(),
                                                      id: products!.data!.want![i].id.toString(),
                                                      type: products!.data!.want![i].type.toString(),
                                                    )));
                                                      ...
                                                      children: [
                                                        ...
                                                        Text(
                                                            DateTime.now()
                                                                .difference(
                                                                DateTime.parse(
                                                                    products!.data!.want![i].createdAt.toString()))
                                                                .inMinutes <=
                                                                59
                                                                ? "${DateTime.now().difference(
                                                                DateTime.parse( products!.data!.want![i].createdAt.toString())).inMinutes} min ago"
                                                                : DateTime.now()
                                                                .difference(DateTime
                                                                .parse( products!.data!.want![i].createdAt.toString()))
                                                                .inHours <=
                                                                23
                                                                ? "${DateTime.now().difference(
