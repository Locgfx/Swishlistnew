                          ...
                          Padding(
                              ...
                              child: (profile!.data!.occupation.toString() ==
                                      ...
                                      onTap: () {
                                        ...
                                        postProfile(
                                          ...
                                          if (value['status'] == true) {
                                            ...
                                            Fluttertoast.showToast(
                                                msg:
                                                    'please add all details fields' /*value['message']*/);
                                          }
                                        });
                                        // }
                                      },
                                  ...
                                  : LightYellowButtonWithText(
                                      ...
                                      textStyleColor: (nameController.text.isNotEmpty && genderController.text.isNotEmpty && dobFormat.isNotEmpty && occupationController.text.isNotEmpty && relationStatus.text.isNotEmpty && emailController.text.isNotEmpty && phoneController.text.isNotEmpty && alternateNo.text.isNotEmpty && homeController.text.isNotEmpty && workController.text.isNotEmpty) ? Colors.black : ColorSelect.colorB5B07A,
                                      onTap: () {
                                        updateProfile(
                                                name: nameController.text,
                                                gender: genderController.text,
