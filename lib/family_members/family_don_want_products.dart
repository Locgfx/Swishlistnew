...
class FamilyDontWantProducts extends StatefulWidget {
  // final LoginResponse response;
  final String familyId;
  final String familyName;
  // final bool isUser;
  const FamilyDontWantProducts({
    Key? key,
  ...
  @override
  State<FamilyDontWantProducts> createState() => _FamilyDontWantProductsState();
}

class _FamilyDontWantProductsState extends State<FamilyDontWantProducts> {
  @override
  void initState() {
    //getProducts();
    getDontWantProducts();
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Expanded(
                            child: Text(
                              '${widget.familyName} does not wants',
                              maxLines: 2,
                                                ...
                                                onTap: () {
                                                  Navigator.push(
                                                      ...
                                                      MaterialPageRoute(
                                                          builder: (context) =>
                                                              FamilyProductDetail(
                                                                name: dontWantProductsType[
                                                                        i]
                                                                    .name
                                                                    .toString(),
                                                                price: dontWantProductsType[
                                                                        i]
                                                                    .price
                                                                    .toString(),
                                                                link: dontWantProductsType[
                                                                        i]
                                                                    .url
                                                                    .toString(),
                                                                image: dontWantProductsType[
                                                                            i]
                                                                        .photo
                                                                        .toString()
                                                                        .contains(
                                                                            'http')
                                                                    ? dontWantProductsType[
                                                                            i]
                                                                        .photo
                                                                        .toString()
                                                                    : baseUrl +
                                                                    dontWantProductsType[i]
                                                                            .photo
                                                                            .toString(),
                                                                purchaseDate: dontWantProductsType[
                                                                        i]
                                                                    .purchasedOn
                                                                    .toString(),
                                                                id: dontWantProductsType[
                                                                        i]
                                                                    .id
                                                                    .toString(),
                                                                type: '',
